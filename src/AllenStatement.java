...
class AllenStatement {
	...
	AllenStatement(String in) {
		...
		this.relation = AllenStatement[1].trim().replaceAll(" ", "_").replaceAll(",_", ", ");
		this.interval1 = new IntervalDescription(AllenStatement[0].trim());
		this.interval2 = new IntervalDescription(AllenStatement[2].trim());
	}

	public String toString() {
		return interval1.getOrigDescription() + " [" + relation + "] " + interval2.getOrigDescription();
	}
